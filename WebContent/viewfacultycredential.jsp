...
<div class="container logo">
		...
		<div class="shopping-cart">
			...
			<div class="check-out">
				...
				<a href="viewfacultybasic" class="continue">Return to Database</a>

				<h2>Faculty Credential Information</h2>
				 ...
				 <br>
					...
					<p><a href="viewfacultybasic" class="continue">Return to Database</a></p>
